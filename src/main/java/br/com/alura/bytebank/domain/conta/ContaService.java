...
public class ContaService {
    ...
    public void realizarSaque(Integer numeroDaConta, BigDecimal valor) {
        ...
        BigDecimal valorSaque = conta.getSaldo().subtract(valor);

        new ContaDAO(connection.recuperarConexao()).alterar(conta.getNumero(), valorSaque);
    }
    ...
    public void realizarDeposito(Integer numeroDaConta, BigDecimal valor) {
        ...
        BigDecimal valorDeposito = conta.getSaldo().add(valor);;

        new ContaDAO(connection.recuperarConexao()).alterar(conta.getNumero(), valorDeposito);
    }
    ...
    public void desativar(Integer numeroDaConta){
        ...
        new ContaDAO(connection.recuperarConexao()).desativar(numeroDaConta);
    }
